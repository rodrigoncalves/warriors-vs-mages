...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { description: @mission.description, duration: @mission.duration, reward: @mission.reward }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { description: @mission.description, duration: @mission.duration, reward: @mission.reward }
    assert_redirected_to mission_path(assigns(:mission))
  end
